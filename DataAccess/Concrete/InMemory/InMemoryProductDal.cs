...
namespace DataAccess.Concrete.InMemory
{
    ...
    {
        List<Product> _products;//glabol oldugundan _ ile tanımladık.
        public InMemoryProductDal()//bellekte referans aldıgında calıscak blok
        {
            //oracle veya sql, mondodbden geliyomus gibi veriler
